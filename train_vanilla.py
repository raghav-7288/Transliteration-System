...
parser.add_argument('-ct', '--cell_type' , help='Type of cell.' , type=str,choices = ['RNN', 'LSTM', 'GRU'], default='GRU')
...
parser.add_argument('-bw', '--beam_width', help='Beam width for beam search.', type=int, default=4)
...
parser.add_argument('-wl', '--w_log', help='To log results on wandb.', type=int, default=1)
